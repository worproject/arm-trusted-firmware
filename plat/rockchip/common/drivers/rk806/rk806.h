...
/* Not used/existing register and configure */
#define NA			-1
...
0 -3:  num
******************************************/
#define CHIP_SELECT_MASK	GENMASK_32(11, 8)
#define CHIP_SELECT_SHIFT	8
#define MASTER			(0x0 << CHIP_SELECT_SHIFT)
#define SLAVER			(0x1 << CHIP_SELECT_SHIFT)

#define REGULATOR_TYPE_MASK	GENMASK_32(7, 4)
#define REGULATOR_TYPE_SHIFT	4
#define BUCK			(0x0 << REGULATOR_TYPE_SHIFT)
#define NLDO			(0x1 << REGULATOR_TYPE_SHIFT)
#define PLDO			(0x2 << REGULATOR_TYPE_SHIFT)

#define REGULATOR_ID_MASK	GENMASK_32(3, 0)
#define REGULATOR_ID_SHIFT	0
...
struct rk806_regulator {
	struct rk_spi_controller *spi;
};

int rk806_init(struct rk806_regulator *instance, struct rk_spi_controller *spi);
int rk806_regulator_set_voltage(struct rk806_regulator *instance, uint32_t reg_id, uint32_t uvolt);
